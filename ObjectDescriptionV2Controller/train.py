...
def main():
    ...
    dataloader_train = DataLoader(train_dataset, batch_size=1, collate_fn=custom_collate_fn)
    dataloader_valid = DataLoader(valid_dataset, batch_size=1, collate_fn=custom_collate_fn)
